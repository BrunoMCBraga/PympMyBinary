class Win32BinaryOffsetsAndSizes:
    ...
    #Resource headers
    OFFSET_TO_NUMBER_OF_NAMED_ENTRIES_WITHIN_RESOURCE_DIRECTORY_HEADER = 0xC
    OFFSET_TO_NUMBER_OF_ID_ENTRIES_WITHIN_RESOURCE_DIRECTORY_HEADER = 0xE
    OFFSET_TO_FIRST_DIRECTORY_ENTRY_WITHIN_RESOURCE_DIRECTORY_HEADER = 0x10
    ...
    NUMBER_OF_DWORDS_ON_DEBUG_ENTRY = 0x7
    ...
    #DELAY IMPORTS
    NUMBER_OF_DWORDS_ON_DELAY_IMPORT_ENTRY = 0x8
    VA_TO_DLL_NAME_OFFSET_WITHIN_DELAY_IMPORT_ENTRY = 0x4
    VA_TO_HMODULE_OFFSET_WITHIN_DELAY_IMPORT_ENTRY = 0x8
    VA_TO_IMPORT_ADDRESS_TABLE_WITHIN_DELAY_IMPORT_ENTRY = 0xC
    VA_TO_IMPORT_NAME_TABLE_WITHIN_DELAY_IMPORT_ENTRY = 0x10
    VA_TO_BOUND_IAT_WITHIN_DELAY_IMPORT_ENTRY = 0x14
    VA_TO_UNLOAD_IAT_WITHIN_DELAY_IMPORT_ENTRY = 0x18