...
class Win32SectionAppender:
    ...
    def _compute_padding_size_for_file_alignment(self, header_offset, size_or_offset):
        ...
        file_alignment = MultiByteHandler.get_dword_given_offset(self.binary_data, header_offset + Win32BinaryOffsetsAndSizes.OFFSET_TO_FILE_ALIGNMENT)
    ...
    def _compute_padding_size_for_section_alignment(self, header_offset, size_or_rva):
        section_alignment = MultiByteHandler.get_dword_given_offset(self.binary_data, header_offset + Win32BinaryOffsetsAndSizes.OFFSET_TO_SECTION_ALIGNMENT)
    ...
    def _adjust_certificate_table(self, header_offset):
        ...
        if certificate_table_rva == 0x0 or not Win32BinaryUtils.rva_requires_change(self.binary_data, header_offset, certificate_table_rva):
            return
    ...
    def _adjust_global_ptr(self, header_offset):
        ...
        if global_ptr_rva == 0x0 or not Win32BinaryUtils.rva_requires_change(self.binary_data, header_offset, global_ptr_rva):
            return
        else:
            raise NotImplementedError
    ...
    def _adjust_load_config_table(self, header_offset):
        ...
        if load_config_table_rva == 0x0 or not Win32BinaryUtils.rva_requires_change(self.binary_data, header_offset, load_config_table_rva):
            return
    ...
    def _adjust_bound_import(self, header_offset):
        ...
        if bound_import_rva == 0x0 or not Win32BinaryUtils.rva_requires_change(self.binary_data, header_offset, bound_import_rva):
            return
        else:
            raise NotImplementedError
    ...
    def _adjust_delay_import_descriptor(self, header_offset):
        ...
        if delay_import_descriptor_rva == 0x0 or not Win32BinaryUtils.rva_requires_change(self.binary_data, header_offset, delay_import_descriptor_rva):
            return
        else:
            raise NotImplementedError
